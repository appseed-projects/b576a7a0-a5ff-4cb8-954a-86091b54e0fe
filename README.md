...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-13 19:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b576a7a0-a5ff-4cb8-954a-86091b54e0fe.git
$ cd b576a7a0-a5ff-4cb8-954a-86091b54e0fe
```
